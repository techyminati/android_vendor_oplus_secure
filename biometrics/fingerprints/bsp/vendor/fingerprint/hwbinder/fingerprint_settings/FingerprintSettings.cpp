...
fpConfigInfo gfpConfigInfos[] = {
    {"20111 20251 20113 20261 20262 20263 20331 20332 20333 20127", {LCD_SAMSUNG, 1630}}, // 0
    {"20817 20827 20831", {LCD_SAMSUNG, 7450}},//mt6893 N2
    {"20135 20235 20139 20161 20351 20352 20163", {LCD_SAMSUNG, 1915}},       // 1
    {"19015 19016 19525 19125 19126 19127 19128 19521 19365 19367 19368 19567 19568 19569 20211 20212 20213 20214 20215", {LCD_DEFAULT, 580}},       // SM7250R G3 (old)
    ...
    {"20031 20311 19815 20857 20858 20859 2085A 21051", {LCD_SAMSUNG, 1700}},  // SM8350R G3S
    {"19550 19551 19553 19556 19354 19357 19358 19359", {LCD_DEFAULT, 660}},  // 9
    {"19011 19301 19305 19536 19537 19538 19539 19541", {LCD_DEFAULT, 660}},  // 10
    {"20291 20292 20293 20294 20295", {LCD_DEFAULT, 1870}},  // 11
    {"19825 20851 20852 20853 20854", {LCD_SAMSUNG, 1760}},        //SM8350R G3S
    {"20627 20664", {LCD_SAMSUNG, 1850}},  //SM8350R G3S
    {"21603 21604 21675 21676", {LCD_SAMSUNG, 1920}},  //SM7325R
    {"20659 20755", {LCD_SAMSUNG, 1915}},  //SM8350R G3S
    {"21617 216B2 216B3 21147", {LCD_SAMSUNG, 2000}},  //SM8350S G3S
    {"20171 20172 20353", {LCD_BOE, 3125}},
    {"20171 20172 20353", {LCD_TM, 1830}},
    {"21005 21205", {LCD_BOE, 0x0EC90D0C}, 80, 150}, //SM8350S G7, 50%HBM = 0xFFFF & 0x0EC90D0C, 75%HBM = 0xFFFF & (0x0EC90D0C >> 16)
    {"21001 21201 21631 216AC 20846 20847 2084A", {LCD_SAMSUNG, 0x0B220708}, 80, 150}, //SM8450 G7
    {"20181 20182 20355 2169E 2169F 21081 216C9 2162D 2162E 21711 21712", {LCD_SAMSUNG, 1600}},
    {"20151 20152 20301 20302 20391 20392 21600 21601 21670 21671", {LCD_DEFAULT, 1900}},      // MT6853 G3S
    {"21007", {LCD_SAMSUNG, 0x22F61E28}, 150, 150}, //mt6983 10293-8950-7720
    {"20057 20058", {LCD_SAMSUNG, 1630}}, // SM7225R
    {"20615 20662 20619 21609 21651", {LCD_SAMSUNG, 1850}},  //MT6893 G3S
    {"21615", {LCD_SAMSUNG, 1800}}, // 21615 G3S
    {"21619 2169A 2169B", {LCD_SAMSUNG, 2000}}, // 21619 JIIOV 0301/G3S
    {"20730 20731 20732 20733", {LCD_SAMSUNG, 1900}},  // MT6785 G3S
    {"19705 19706 19795 20607", {LCD_SAMSUNG, 800}}, // 19705 G3
    {"21015 21016 21217 21218", {LCD_BOE, 7800}}, //MT6893 G3S
    {"21015 21016 21217 21218", {LCD_TM, 7800}}, //MT6893 G3S
    {"21015 21016 21217 21218", {LCD_TM2, 8150}}, //MT6893 G3S
    {"21061", {LCD_SAMSUNG, 1630}}, //MT6893 G3S
    {"20711 20712 20713 20714", {LCD_SAMSUNG, 1900}},  // SM7125R G3S
    {"206B1 206B2 206B3 206B5", {LCD_SAMSUNG, 1900}},  // SM7125R G3S
    {"20241 20242 20243 20245 20246 20247 20248 20384 20385 20386", {LCD_SAMSUNG, 1900}}, //SM6115
...
void fpSettingsInit()
{
    ...
    if (read_proc_string_data(LCD_TYPE_PATH, lcdName) == NULL) {
        ...
        } else if (strstr(lcdName, TM2_KEYWORD)) {
            gFpConfigDevice.type = LCD_TM2;
...
static int fpGetHbmDelay()
{
    return gfpConfigInfos[gFpConfigDevice.fpConfigChooseIndex].hbm_delay;
}

static int fpGetBrightnessDelay()
{
    return gfpConfigInfos[gFpConfigDevice.fpConfigChooseIndex].bright_delay;
}
...
int fpGetDataById(void *para)
{
    ...
    case FP_CMD_GET_LCD_TYPE:
        ...
        break;
    case FP_CMD_GET_HBM_DELAY:
        data.response = fpGetHbmDelay();
        break;
    case FP_CMD_GET_BRIGHT_DELAY:
        data.response = fpGetBrightnessDelay();
        break;
    default:
