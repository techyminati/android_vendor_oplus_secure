...
#ifndef VENDOR_OPLUS_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_SileadFingerprint_H
#define VENDOR_OPLUS_HARDWARE_BIOMETRICS_FINGERPRINT_V2_1_SileadFingerprint_H
...
#define DYNAMICAL_LOG_CLOSE (0)
#define DYNAMICAL_LOG_CAPTURE_IMAGE (2)
#define FP_START_IMAGE_DUMP_CMD   (1)
#define FP_STOP_IMAGE_DUMP_CMD    (0)
...
struct SileadFingerprint : public IBiometricsFingerprint {
public:
    SileadFingerprint();
    ~SileadFingerprint();
