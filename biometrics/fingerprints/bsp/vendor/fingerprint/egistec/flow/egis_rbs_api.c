...
int rbs_chk_secure_id(unsigned int user_id, unsigned long long sid)
{
	...
	ex_log(LOG_INFO, "#*rbs_chk_secure_id#*#*[leave] %d#*", retval);
	return retval;
}
...
{
	ex_log(LOG_INFO, "#*rbs_navigation#*#*[enter]#*\n");
	...
	ex_log(LOG_INFO, "#*rbs_navigation#*#*[leave] #*\n");
...
{
	ex_log(LOG_INFO, "#*rbs_clean_up#*#*[enter]#*");
	
	int retval = cpt_clean_up();

	ex_log(LOG_INFO, "#*rbs_clean_up#*#*[leave] %d#*", retval);
...
{
	ex_log(LOG_INFO, "#*rbs_set_touch_event_listener#*#*[enter]#*");
	
	int retval = cpt_set_locker_mode();

	ex_log(LOG_INFO, "#*rbs_set_touch_event_listener#*#*[leave] %d#*", retval);
...
{
	ex_log(LOG_INFO, "#*rbs_get_screen_state#*#*[enter]#*");

	int retval = cpt_get_screen_state(screen_state);

	ex_log(LOG_INFO, "#*rbs_get_screen_state#*#*[leave] %d#*", retval);
...
{
	ex_log(LOG_INFO, "#*rbs_keymode_enable#*#*[enter]#*");

	int retval = cpt_keymode_enable(enable);
	
	ex_log(LOG_INFO, "#*rbs_keymode_enable#*#*[leave] %d#*", retval);
