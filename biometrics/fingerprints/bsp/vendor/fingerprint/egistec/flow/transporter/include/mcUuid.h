...
static _UNUSED const mcUuid_t MC_UUID_FREE = {MC_UUID_FREE_DEFINE};
...
static _UNUSED const mcUuid_t MC_UUID_RESERVED = {MC_UUID_RESERVED_DEFINE};
...
static _UNUSED const mcUuid_t MC_UUID_SYSTEM = {MC_UUID_SYSTEM_DEFINE};
...
static _UNUSED const mcUuid_t MC_UUID_RTM = {MC_UUID_RTM_DEFINE};
