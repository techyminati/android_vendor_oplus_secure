...
#define OBJ_DESC_init(obj_desc, the_id, the_name, major, minor, the_header_size) \
    ...
    obj_desc->id = the_id;                                                       \
    mem_move(obj_desc->name, the_name,                                             \
           sizeof(the_name) > OBJ_NAME_SIZE ? OBJ_NAME_SIZE : sizeof(the_name)); \
...
#define RBSOBJ_get_obj_total_size(obj) obj->obj_desc.payload_size + sizeof(*obj)

#define RBSOBJ_get_payload_pointer(obj) \
    (((uint8_t*)obj) + sizeof(obj->obj_desc) + obj->obj_desc.header_size)

#define RBSOBJ_get_payload_size(obj) obj->obj_desc.payload_size

#define RBSOBJ_get_objarray_obj_id(obj) ((rbs_obj_desc_t*)RBSOBJ_get_payload_pointer(obj))->id
