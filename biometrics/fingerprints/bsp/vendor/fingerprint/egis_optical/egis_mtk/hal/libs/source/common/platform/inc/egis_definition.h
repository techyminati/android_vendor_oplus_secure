...
EXT int SENSOR_FULL_WIDTH;
EXT int SENSOR_FRAME_OFFSET_X;
EXT int SENSOR_FRAME_OFFSET_Y;
EXT int NAV_WINDOW_H;
EXT int NAV_WINDOW_W;
EXT int NAV_REF_H;
EXT int NAV_REF_W;
EXT int NAV_START_ROW;
EXT int NAV_START_COL;
EXT int NAV_END_ROW;
EXT int NAV_END_COL;
EXT int SCAN_Z2_COL_BEGIN;
EXT int SCAN_Z2_COL_END;
EXT int SCAN_Z2_COL_STEP;
EXT int SCAN_Z2_ROW_BEGIN;
EXT int SCAN_Z2_ROW_END;
EXT int SCAN_Z2_ROW_STEP;
EXT int NAV_REF_OFFSET_W;
EXT int NAV_REF_OFFSET_H;
EXT int Z2_WIDTH;
EXT int Z2_HEIGHT;
#undef EXT
...
#define SENSOR_ID_ET701 726

#ifdef ALGO_OUT_BPP_32
#define MAX_IMG_SIZE (255 * 255 * 4)
#else
...
#define EGIS_NO_NEED_UPDATE 34
#define EGIS_CHECKSUM_NOT_MATCH 39

#define EGIS_NOT_SEND_TEMPL 44
#define EGIS_SPI_FAIL 50
#define EGIS_GET_SET_CONTINUE 2003
#define EGIS_TEMPL_NEED_UPGRADED 42
...
#define EGIS_READ_SENSOR_INFO_START 50
#define EGIS_READ_SENSOR_INFO_END 51
#define EGIS_POWER_OFF_ON 52
#define EGIS_SENSOR_TEST_FAIL 53
#define EGIS_NOT_IMPLEMENT 54

#define EGIS_CHECKSUM_INVALID_PARAMETER 56
#define EGIS_CALIBRATION_VERSION_LOW 57

#define EGIS_BKG_NOT_EXIST 58