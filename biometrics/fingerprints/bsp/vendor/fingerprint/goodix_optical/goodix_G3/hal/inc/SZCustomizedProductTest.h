...
namespace goodix
{
    ...
    public:
        ...
        gf_error_t findTargetExposureTime(gf_sz_expo_auto_calibration_t *expo_auto_calibration,
                gf_sz_exposure_data_t *exposure_dump_data, uint16_t exposure_time, bool is_check);
        gf_error_t findTargetExposureTimeLincoln(gf_sz_expo_auto_calibration_t *expo_auto_calibration,
    ...
    private:
        ...
        float actureGain;
    public:
        gf_error_t getQRCode();
        gf_error_t findTargetExposureTimeLincolnTest(
        ...
        float findActualGain (float gain, int8_t up_value);
    };
}  // namespace goodix
