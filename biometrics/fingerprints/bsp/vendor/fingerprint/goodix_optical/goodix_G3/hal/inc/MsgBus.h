...
namespace goodix
{
    ...
    public:
        enum
        {
            ...
            MSG_TA_DEAD,
            MSG_AUTHENTICATE_SUCCESS_NOTIFY_FIRST,
            MSG_AUTHENTICATE_NEED_RETRY,
            MSG_AUTHENTICATE_NOT_MATCH_NOTIFY_FIRST,
            MSG_MAX
        };
        ...
        void sendMessage(int32_t msg, int32_t params1, int32_t params2, int32_t params3);
