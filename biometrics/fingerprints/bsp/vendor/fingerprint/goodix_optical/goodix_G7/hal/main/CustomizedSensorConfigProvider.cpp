...
#define DEFAULT_SENSOR_RADIUS (114)
#define DEFAULT_SENSOR_LOCATION "720::2463::0::0::0::0::0::0"  // x = 0.5 * x pixel  y = y pixel - iconsize
#define DEFAULT_SENSOR_LOCATION_BOE "720::2463::0::0::0::0::0::0"  // boe tp report location
#define PROPERTY_SENSOR_ROTATION "persist.vendor.fingerprint.optical.sensorrotation"
#define DEFAULT_SENSOR_ROTATION "79"
    ...
    gf_error_t CustomizedSensorConfigProvider::getConfig(GoodixSensorConfig *config, int32_t sensorNum) {
        ...
        do {
            ...
            if (SensorConfigProvider::getConfig(&tmpConfig, sensorNum) == GF_SUCCESS) {
                ...
                if (mProductScreenId == SCREEN_TYPE_AA202_BOE_ID) {
                    ret = property_get(PROPERTY_SENSOR_LOCATION, (char*)propertyStr, DEFAULT_SENSOR_LOCATION_BOE);
                } else {
