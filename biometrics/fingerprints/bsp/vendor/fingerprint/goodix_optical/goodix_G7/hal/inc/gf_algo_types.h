...
typedef enum {
    ...
    GF_CMD_ALGO_ENROLL_GET_FEATURE_ONE,
    GF_CMD_ALGO_ENROLL_GET_FEATURE_THREE,
    GF_CMD_ALGO_ENROLL_GET_FEATURE_AFTER_THREE,
    GF_CMD_ALGO_ENROLL_GET_FEATURE_FOUR,
    GF_CMD_ALGO_ENROLL_GET_FEATURE_FIVE,
    GF_CMD_ALGO_SKIN_DETECTION,
    GF_CMD_ALGO_GET_SKIN_THRESHOLD,
    GF_CMD_ALGO_MAX
} gf_algo_cmd_id_t;
...
typedef struct {
    ...
    int32_t o_rawdata_mean;  // used by customer
