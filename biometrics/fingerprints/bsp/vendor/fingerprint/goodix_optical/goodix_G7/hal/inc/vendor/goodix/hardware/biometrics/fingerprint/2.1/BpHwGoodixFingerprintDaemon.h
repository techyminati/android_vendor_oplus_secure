...
struct BpHwGoodixFingerprintDaemon : public ::android::hardware::BpInterface<IGoodixFingerprintDaemon>, public ::android::hardware::details::HidlInstrumentor {
    ...
    static ::android::hardware::Return<void>  _hidl_setNotify(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::vendor::goodix::hardware::biometrics::fingerprint::V2_1::IGoodixFingerprintDaemonCallback>& callback);
    static ::android::hardware::Return<void>  _hidl_sendCommand(::android::hardware::IInterface* _hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, int32_t cmdId, const ::android::hardware::hidl_vec<int8_t>& in_buf, sendCommand_cb _hidl_cb);

    // Methods from ::vendor::goodix::hardware::biometrics::fingerprint::V2_1::IGoodixFingerprintDaemon follow.
    ::android::hardware::Return<void> setNotify(const ::android::sp<::vendor::goodix::hardware::biometrics::fingerprint::V2_1::IGoodixFingerprintDaemonCallback>& callback) override;
