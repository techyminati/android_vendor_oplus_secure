...
namespace goodix {
    ...
    public:
        ...
        virtual gf_error_t automatic_send_touchdown();
        virtual gf_error_t automatic_send_touchup();
        virtual gf_error_t clear_kernel_touch_flag();
        inline void setSpiSpeed(int32_t speed) {
            mSpiSpeed = speed;
        }
        inline void setAuthScreenState(int32_t State) {
            mAuthScreenState = State;
        }
        inline int32_t getAuthScreenState() {
            return mAuthScreenState;
        }
