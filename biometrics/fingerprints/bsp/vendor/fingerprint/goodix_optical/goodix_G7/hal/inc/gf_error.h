...
typedef enum gf_error {
    ...
    GF_ERROR_RPMB_READ_ERROR,  // GF_ERROR_BASE + 160,
    ...
    GF_ERROR_HEART_RATE_CALCULATE_FAIL,
    GF_ERROR_TA_TRANSFER_SIZE,  // GF_ERROR_BASE + 170,
    GF_ERROR_TEMPORARY_LOCKOUT,
    GF_ERROR_PERMANENT_LOCKOUT,
    ...
    GF_ERROR_SENSOR_ID_DISMATCH,  // GF_ERROR_SPI_TEST + 35,
    GF_ERROR_HRD_NOISE,  // GF_ERROR_SPI_TEST + 36,
    GF_ERROR_FLESH_3D_EXCHANGE,  // GF_ERROR_SPI_TEST + 37,
    GF_ERROR_HBLACK_RANGE,  // GF_ERROR_SPI_TEST + 38,
    GF_ERROR_TEST_HEAD_DEPTH,  // GF_ERROR_SPI_TEST + 39,
    ...
    GF_SZ_FT_ERROR_IRREGULAR_SPOT_INIT_FAIL = GF_ERROR_SZ_FT_BASE + 0xa0,
    GF_SZ_FT_ERROR_IRREGULAR_SPOT_CHECK_FAIL = GF_ERROR_SZ_FT_BASE + 0xa1,

    GF_SZ_FT_ERROR_SCALE_RATIO_DIVIDE_BY_0 = GF_ERROR_SZ_FT_BASE + 0xa4,
    GF_SZ_FT_ERROR_SCALE_RATIO_ERR_LINE_NUM = GF_ERROR_SZ_FT_BASE + 0xa5,
    GF_SZ_FT_ERROR_SCALE_RATIO_ERR_PARALLEL_LINE = GF_ERROR_SZ_FT_BASE + 0xa6,
    GF_SZ_FT_ERROR_SCALE_RATIO_ERR_CROSS_LINE = GF_ERROR_SZ_FT_BASE + 0xa7,
    GF_SZ_FT_ERROR_LB_BASE_INIT_FAIL = GF_ERROR_SZ_FT_BASE + 0xa8,
    GF_SZ_FT_ERROR_LB_BASE = GF_ERROR_SZ_FT_BASE + 0xa9,
    GF_SZ_FT_ERROR_LB_BASE_CHECK_FAILED = GF_ERROR_SZ_FT_BASE + 0xaa,
