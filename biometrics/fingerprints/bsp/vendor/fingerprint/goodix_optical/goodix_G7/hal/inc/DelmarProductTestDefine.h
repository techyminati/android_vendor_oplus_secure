...
namespace goodix
{
    ...
    enum
    {
        ...
        PRODUCT_TEST_TOKEN_RESULT_REDRATIO = PRODUCT_TEST_TOKEN_RESULT_ANTIFAKE_DY + 1,
        PRODUCT_TEST_TOKEN_CHECK_BEFORE_KB = PRODUCT_TEST_TOKEN_RESULT_REDRATIO + 1,
        PRODUCT_TEST_TOKEN_RESULT_MIN_DIFF_BLACK_LD,
        PRODUCT_TEST_TOKEN_RESULT_HRD_NOISE,
        PRODUCT_TEST_TOKEN_IS_LB_MODE,
        PRODUCT_TEST_TOKEN_EXP_TIME_OF_CONFIG,
        PRODUCT_TEST_TOKEN_IS_LOCAL_HBM,
        PRODUCT_TEST_TOKEN_RESULT_RESERVED,
        PRODUCT_TEST_TOKEN_RESULT_FLESH_3D_FOOL,
        PRODUCT_TEST_TOKEN_SENSOR_ID_LEN,
        PRODUCT_TEST_TOKEN_SUPPORT_AUTO_EXPO,
        PRODUCT_TEST_TOKEN_SUPPORT_PWM_EXPO,
        PRODUCT_TEST_TOKEN_RESULT_TEST_HEAD_DEPTH,
        ...
        PRODUCT_TEST_TOKEN_GHBM_FLAG = 319900,
        PRODUCT_TEST_TOKEN_HB_ALGO_VERSION = 320000,
        PRODUCT_TEST_TOKEN_HB_VERSION,
    };
};  // namespace goodix
