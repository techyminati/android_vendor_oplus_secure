...
#ifndef PROPERTY_FINGERPRINT_DISABLE_STUDY
#define PROPERTY_FINGERPRINT_DISABLE_STUDY "fingerprint.disable.study"
#endif  // PROPERTY_FINGERPRINT_DISABLE_STUDY
...
namespace goodix {
    ...
    gf_error_t DelmarFingerprintCore::onAfterAuthAlgo(AuthenticateContext *context) {
        ...
        do {
            ...
            if (config->support_independent_fast_auth > 0 && context->auth_cmd->i_retry_count == 0 && config->common.max_authenticate_failed_attempts > 0 &&
    ...
    bool DelmarFingerprintCore::needRetryByResult(HalContext *context, gf_error_t result,
        ...
        bool needRetry = (result == GF_ERROR_NOT_MATCH
            ...
            || (result == GF_ERROR_NOT_LIVE_FINGER && authSupportLongExpo == 0
