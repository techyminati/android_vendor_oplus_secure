...
TZ_RESULT UREE_AllocSecuremem(UREE_SESSION_HANDLE session,
    ...
    ret = _allocFunc(TZCMD_MEM_SECUREMEM_ALLOC, session, mem_handle, alignment, size, (char *) "UREE_AllocSecuremem", NULL);
...
TZ_RESULT UREE_AllocSecurememWithTag(UREE_SESSION_HANDLE session,
    ...
    ret = _allocFunc(TZCMD_MEM_SECUREMEM_ALLOC_WITH_TAG, session, mem_handle, alignment, size, (char *) "UREE_AllocSecuremem", tag);
...
TZ_RESULT UREE_ZallocSecurememWithTag(UREE_SESSION_HANDLE session,
	...
	//fix me!!!
    ret = _allocFunc(TZCMD_MEM_SECUREMEM_ZALLOC_WITH_TAG, session, mem_handle, alignment, size, (char *) "UREE_ZallocSecuremem", tag);
...
TZ_RESULT UREE_ReferenceSecuremem(UREE_SESSION_HANDLE session, UREE_SECUREMEM_HANDLE mem_handle) {
    ...
    ret = _handleOpFunc(TZCMD_MEM_SECUREMEM_REF, session, mem_handle, (char *) "UREE_ReferenceSecuremem");
...
TZ_RESULT UREE_UnreferenceSecuremem(UREE_SESSION_HANDLE session, UREE_SECUREMEM_HANDLE mem_handle) {
    ...
    ret = _handleOpFunc_1(TZCMD_MEM_SECUREMEM_UNREF, session, mem_handle, &count, (char *) "UREE_UnreferenceSecuremem");
#ifdef DBG_UREE_MEM
				...
				uint32_t alignment, uint32_t size) 
{
	...
	ret = _allocchmFunc(TZCMD_MEM_SECUREMULTICHUNKMEM_ALLOC,
			...
			alignment, size, (char *) "UREE_Mem_AllocSecureMultichunkmem", NULL);
				...
				uint32_t alignment, uint32_t size)
{
	...
	ret = _allocchmFunc(TZCMD_MEM_SECUREMULTICHUNKMEM_ZALLOC,
			session, chm_handle, mem_handle,
			alignment, size, (char *) "UREE_Mem_ZallocSecureMultichunkmem", NULL);
				...
				uint32_t alignment, uint32_t size, const char *tag) 
{
	...
	ret = _allocchmFunc(TZCMD_MEM_SECUREMULTICHUNKMEM_ALLOC_WITH_TAG,
			session, chm_handle, mem_handle,
			alignment, size, (char *) "UREE_Mem_AllocSecureMultichunkmem", tag);
				...
				uint32_t alignment, uint32_t size, const char *tag)
{
	...
	ret = _allocchmFunc(TZCMD_MEM_SECUREMULTICHUNKMEM_ZALLOC_WITH_TAG,
			session, chm_handle, mem_handle,
			alignment, size, (char *) "UREE_Mem_ZallocSecureMultichunkmem", tag);
...
TZ_RESULT UREE_ReferenceSecurechunkmem(UREE_SESSION_HANDLE session, UREE_SECURECM_HANDLE cm_handle) {
    ...
    ret = _handleOpFunc(TZCMD_MEM_SECURECM_REF, session, cm_handle, (char *) "UREE_ReferenceSecurechunkmem");
...
TZ_RESULT UREE_UnreferenceSecurechunkmem(UREE_SESSION_HANDLE session, UREE_SECURECM_HANDLE cm_handle) {
    ...
    ret = _handleOpFunc_1(TZCMD_MEM_SECURECM_UNREF, session, cm_handle, &count, (char *) "UREE_UnreferenceSecurechunkmem");
#ifdef DBG_UREE_MEM
