...
#define DELMAR_AUTOCALI_PARAM_BUFFER_LEN           (792844)
...
#define HEART_BAET_RATE_MIN_SAMPLE_COUNT    (HEART_BEAT_RATE_SAMPLING_RATE * HEART_BEAT_RATE_MIN_CALC_TIME)
#define HEART_BAET_RATE_MAX_SAMPLE_COUNT    (HEART_BEAT_RATE_SAMPLING_RATE * HEART_BEAT_RATE_MAX_CALC_TIME)
