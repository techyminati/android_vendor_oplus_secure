...
namespace goodix {
    ...
    enum NETLINK_CMD
    {
        ...
        GF_NETLINK_TP_TOUCH_DOWN = 4,
        GF_NETLINK_TP_TOUCH_UP = 5,
        GF_NETLINK_UI_READY = 6,
        GF_NETLINK_UI_DISAPPEAR = 7,
    ...
    public:
        ...
        virtual gf_error_t stop_wait_fingerprint_event();
        ...
        public:
            ...
            virtual void interruptProcessFpEvent();
            virtual void netlinkProcessFpEvent();
