...
enum
{
    ...
    GF_SZ_CMD_TEST_FRR_FAR_PLAY_ENROLL,
    ...
    GF_SZ_CMD_FACTORY_TEST_SAMPLE_EXIT,
...
#if 1
    GF_SZ_CMD_FACTORY_TEST_CHECK_AE_PARAM, // 54
    GF_SZ_CMD_FACTORY_TEST_FIND_BRIGHTEST_POINT3P, //55
    GF_SZ_CMD_FACTORY_TEST_FIND_BRIGHTEST_POINT,
    GF_SZ_CMD_FACTORY_TEST_FIND_TARGET_EXPO_TIME, //57
#endif
    GF_SZ_CMD_TEST_MAX
};
