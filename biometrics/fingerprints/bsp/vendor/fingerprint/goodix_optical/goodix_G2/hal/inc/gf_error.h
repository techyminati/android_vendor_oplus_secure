...
typedef enum gf_error
{
    ...
    GF_ERROR_CREATE_FINGER_TEMPLATE,  // = GF_ERROR_BASE + 107,
    GF_ERROR_DUMP_CONFIG_NOT_CORRECT,  // = GF_ERROR_BASE + 108,
    GF_ERROR_INVALID_STATE,  // = GF_ERROR_BASE + 109,
    GF_ERROR_PRE_DETECT_FAILED_AND_RETRY,  // = GF_ERROR_BASE + 110,
    GF_ERROR_MT_INFO_CHECK_FAIL,  // = GF_ERROR_BASE+111,
    GF_ERROR_TEST_RESET_INT_PIN_MCU,  // GF_ERROR_BASE + 112,
    GF_ERROR_TEST_RESET_INT_PIN_SENSOR,  // GF_ERROR_BASE + 113,
    GF_ERROR_TEST_RESET_INT_PIN_PMIC,  // GF_ERROR_BASE + 114,
    GF_ERROR_TEST_MT,  // GF_ERROR_BASE + 115,
    GF_ERROR_TEST_SPMT,  // GF_ERROR_BASE + 116,
    GF_ERROR_TEST_OTP,  // GF_ERROR_BASE + 117,
    GF_ERROR_CHIP_IS_NOT_READY,  // GF_ERROR_BASE + 118,
    GF_ERROR_FACTORY_FOV_INVALID,  // GF_ERROR_BASE + 119,
    GF_ERROR_FACTORY_BADPOINT_INVALID,  // GF_ERROR_BASE + 120,
    GF_ERROR_FACTORY_SCALE_INVALID,  // GF_ERROR_BASE + 121,
    GF_ERROR_FACTORY_TNOISE_INVALID,  // GF_ERROR_BASE + 122,
    GF_ERROR_FACTORY_SNOISE_INVALID,  // GF_ERROR_BASE + 123,
    GF_ERROR_FACTORY_FLESH_TOUCHDIFF_INVALID,  // GF_ERROR_BASE + 124,
    GF_ERROR_FACTORY_LIGHT_LEAK_RATIO_INVALID,  // GF_ERROR_BASE + 125
    GF_ERROR_FACTORY_RELATIVEILLUMINANCE_INVALID,  // GF_ERROR_BASE + 126,
    GF_ERROR_FACTORY_CROP_INVALID,  // GF_ERROR_BASE + 127,
    GF_ERROR_FACTORY_SSNR_INVALID,  // GF_ERROR_BASE + 128,
    GF_ERROR_FACTORY_SHAPENESS_INVALID,  // GF_ERROR_BASE + 129,
    GF_ERROR_FACTORY_CONSTRAST_INVALID,  // GF_ERROR_BASE + 130,
    GF_ERROR_FACTORY_RAWDATA_INVALID,  // GF_ERROR_BASE + 131,
    GF_ERROR_HOLD_MCU_FAILED,  // GF_ERROR_BASE + 132,
    GF_ERROR_CAPTURE_IMAGE_FAILED,  // GF_ERROR_BASE + 133,
    GF_ERROR_NO_NEED_FORCE_STUDY,
    GF_ERROR_NOT_LIVE_FINGER,
    GF_ERROR_RESIDUAL_FINGER,
    GF_ERROR_FACTORY_SCREEN_STRUCT_INVALID,
    GF_ERROR_ALGO_INIT_FAILED,
    GF_ERROR_SPI_CLOSED,
    GF_ERROR_NOT_MATCH_NOT_LIVE_FINGER,
