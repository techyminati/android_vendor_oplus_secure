...
namespace goodix {
    ...
    int (*gf_proxy_dsp_init)(int32_t, int32_t) = NULL;
    int (*gf_proxy_dsp_reinit)(int32_t, int32_t) = NULL;
    ...
    gf_error_t HalDsp::proxyHandleInit(void)
    {
        ...
        do
        {
            ...
            gf_proxy_dsp_init = (int (*)(int32_t, int32_t))dlsym(g_proxy_handle, "gf_proxy_dsp_init");
            gf_proxy_dsp_reinit = (int (*)(int32_t, int32_t))dlsym(g_proxy_handle, "gf_proxy_dsp_reinit");
    ...
    gf_error_t HalDsp::reinit()
    {
        ...
        do
        {
            ...
            ret = gf_proxy_dsp_reinit(fd, len);
            if (ret)
            {
