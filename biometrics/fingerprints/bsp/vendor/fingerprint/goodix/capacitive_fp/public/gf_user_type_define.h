...
#ifndef _GF_USER_TYPE_DEFINE_H_
#define _GF_USER_TYPE_DEFINE_H_
...
typedef enum
{
    ...
    GF_USER_CMD_INIT_CA_AUTH,
    GF_USER_CMD_CONFIRM_CA_AUTH,
} gf_user_cmd_id_t;
