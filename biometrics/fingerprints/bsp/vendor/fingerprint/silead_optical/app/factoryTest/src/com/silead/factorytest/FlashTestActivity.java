...
public class FlashTestActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.test_flash_main);

        mResultTextview = (TextView) findViewById(R.id.test_flash_result);
        ...
        setDefaultTimeOut();
        mFingerManager.testFlash(mTestCmdCallback);
    }
    ...
    private FingerManager.TestCmdCallback mTestCmdCallback = new FingerManager.TestCmdCallback() {
        ...
        public void onTestResult(int cmdId, Object result) {
            if (cmdId == FingerManager.TEST_CMD_TEST_FLASH && result instanceof FingerResult) {
                int result_pass = -1;
                ...
                if (rsp.getErrorCode() == FingerManager.TEST_RESULT_OK) {
                    ...
                    mResultTextview.setTextAppearance(FlashTestActivity.this, R.style.TestResultPassStyle);
                    result_pass = 0;
                } else {
                    mResultTextview.setText(R.string.globle_test_result_fail);
                    mResultTextview.setTextAppearance(FlashTestActivity.this, R.style.TestResultFailStyle);
                }
