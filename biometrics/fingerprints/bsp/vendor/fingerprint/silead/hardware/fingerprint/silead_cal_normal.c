...
static uint32_t m_config_reset_enable = 0;
...
int32_t silfp_cal_normal_init(uint32_t feature)
{
    ...
    LOG_MSG_VERBOSE("calibrate=%d, calibrate2_nofinger=%d, calibrate2=%d, m_cal_cfg_max_size=%d, reset=%d",
                    m_need_calibrate, m_need_calibrate2_with_nofinger, m_need_calibrate2, m_cal_cfg_max_size, m_config_reset_enable);
