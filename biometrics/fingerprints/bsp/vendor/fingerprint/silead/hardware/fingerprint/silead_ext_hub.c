...
static void _ext_hub_process_wakeup_callback(int32_t fd, short flags, void *param)
{
    int32_t ret = 0;
    char buff[16] = {0};
...
static void *_ext_hub_event_loop(void *param)
{
    int32_t ret = 0;
    int32_t filedes[2] = {0};
...
static void _ext_hub_listen_callback(int32_t fd, short flags, void *param)
{
    int32_t ret = 0;
...
static void _ext_hub_process_command_callback(int32_t fd, short flags, void *param)
{
    int32_t ret = 0;
    void *p_record = NULL;
    size_t recordlen = 0;
