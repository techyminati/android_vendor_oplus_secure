...
typedef enum fingerprint_acquired_info {
    ...
    GX_FINGERPRINT_ACQUIRED_DUPLICATE_FINGER = 1105,  /* For Goodix fp, the finger has enrolled a fingerprint,
                                                        we can not enroll another fingerprint with this finger */
    GX_FINGERPRINT_ACQUIRED_DUPLICATE_AREA = 1106    /* For Goodix fp, we should move the finger,
                                                        then the sensor can capture the other area fingerprint of the finger */
#endif /* OPLUS_FEATURE_FINGERPRINT */
