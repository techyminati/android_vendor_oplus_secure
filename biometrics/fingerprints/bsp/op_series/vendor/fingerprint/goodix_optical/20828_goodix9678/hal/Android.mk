...
LOCAL_MODULE := libgf_hal_dump_G6_7_oplus
...
LOCAL_MODULE := libgf_hal_goodix_sec_G6_7_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_ext_modules_G6_7_oplus
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_product_test_G6_7_oplus
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE := libgf_hal_20828_G6_7_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MULTILIB := both
...
CONFIG_MACROS += \
	...
	-DGF_HAL_VERSION=\"a741e00_6273aeb_6ee1c22_2020.12.24_10:57:36\"
endif

ifeq ($(TARGET_MODE), release)
CONFIG_MACROS += \
    -DGF_LOG_LEVEL=3 \
	-DGF_HAL_VERSION=\"a741e00_6273aeb_6ee1c22_2020.12.24_11:02:36\"
endif

ifeq ($(TARGET_MODE), userdebug)
CONFIG_MACROS += \
    -DGF_HAL_VERSION=\"a741e00_6273aeb_6ee1c22_2020.12.24_11:01:22\"
endif
...
LOCAL_STATIC_LIBRARIES += \
    libgf_hal_dump_G6_7_oplus \
    libgf_hal_goodix_sec_G6_7_oplus \
    libgf_hal_ext_modules_G6_7_oplus \
    libgf_hal_product_test_G6_7_oplus
