...
namespace goodix {
    ...
    class DebugTools : public ExtModuleBase, public HalBase, public IEventHandler {
    public:
        explicit DebugTools(HalContext *context);
        virtual ~DebugTools();
    ...
    DebugTools *createDebugTools(HalContext *context);
}  // namespace goodix


#endif /* _DEBUGTOOLS_H_ */
