...
#define OPLUS_ENROLL_TIME_OUT (10 * 60 * 1000 * 1000)
...
namespace goodix {
    ...
    uint64_t FingerprintCore::preEnroll() {
        ...
        mPreEnrollTime = HalUtils::getCurrentTimeMicrosecond();
    ...
    gf_error_t FingerprintCore::enroll(const void *hat, uint32_t gid,
        ...
        int64_t now = HalUtils::getCurrentTimeMicrosecond();
    ...
    void FingerprintCore::onError(gf_error_t err) {
        ...
        switch (err) {
            ...
            case GF_ERROR_BRIGHTNESS_NOT_STABILITY:
