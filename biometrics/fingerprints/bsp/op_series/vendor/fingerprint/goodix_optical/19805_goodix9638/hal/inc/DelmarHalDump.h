...
#ifdef SUPPORT_HEARTBEAT_RATE
#include "DelmarHeartbeatDefine.h"
#endif  // SUPPORT_HEARTBEAT_RATE
...
namespace goodix {
...
#ifdef SUPPORT_HEARTBEAT_RATE
        virtual gf_error_t dumpHeartBeatSample(int32_t finger_times);
        virtual gf_error_t dumpHeartBeatOrigin(int32_t finger_status, int32_t finger_times);
        virtual gf_error_t dumpHeartBeatPPGData(int32_t finger_times);
        virtual gf_error_t dumpHeartBeatResultData(gf_delmar_hb_result_msg_data_t* msg_data);
#endif  // SUPPORT_HEARTBEAT_RATE
    ...
    protected:
        ...
        virtual gf_error_t doDumpHeartBeatSamplingData(AsyncMessage *msg);
        virtual gf_error_t doDumpHeartBeatSamplingOriginData(AsyncMessage *msg);
        virtual gf_error_t doDumpHeartBeatSamplingDataTimeStamp(AsyncMessage *msg);
        virtual gf_error_t doDumpHeartBeatPPGData(AsyncMessage *msg);
        virtual gf_error_t doDumpHeartBeatResultData(AsyncMessage *msg);
        ...
        gf_error_t getAuthDumpDir(char dirPath[GF_DUMP_FILE_PATH_MAX_LEN], uint32_t groupId,
                uint32_t fingerId, char *userFingerNumber, bool isTriggeredBySystemApp);
        virtual uint32_t getDumpVersion();
    ...
    private:
        ...
        uint32_t mOriginEnrollFingerId;
    };
}  // namespace goodix
