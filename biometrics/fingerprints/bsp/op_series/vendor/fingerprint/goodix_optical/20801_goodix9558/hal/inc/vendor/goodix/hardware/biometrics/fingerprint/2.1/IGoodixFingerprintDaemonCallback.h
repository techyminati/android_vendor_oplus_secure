...
struct IGoodixFingerprintDaemonCallback : public ::android::hidl::base::V1_0::IBase {
    ...
    static ::android::hardware::Return<::android::sp<IGoodixFingerprintDaemonCallback>> castFrom(const ::android::sp<IGoodixFingerprintDaemonCallback>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IGoodixFingerprintDaemonCallback>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IGoodixFingerprintDaemonCallback>&);
