...
namespace goodix {
    ...
    bool EventCenter::hasUiReadyEvt()
    {
        return mEventQueue.contains(EVENT_UI_READY);
    }

    bool EventCenter::hasUiDisEvt()
    {
        return mEventQueue.contains(EVENT_UI_DISAPPEAR);
    }
    ...
    bool EventCenter::threadLoop() {
        while (!Thread::exitPending()) {
            ...
            {  // NOLINT(660)
                ...
                LOG_V(LOG_TAG, "[%s] Get event %d end", __func__, e);
            }
