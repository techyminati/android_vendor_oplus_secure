...
struct IGoodixFingerprintDaemon : public ::android::hidl::base::V1_0::IBase {
    ...
    // @entry
    virtual ::android::hardware::Return<void> setNotify(const ::android::sp<IGoodixFingerprintDaemonCallback>& callback) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IGoodixFingerprintDaemon>> castFrom(const ::android::sp<IGoodixFingerprintDaemon>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IGoodixFingerprintDaemon>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IGoodixFingerprintDaemon>&);
