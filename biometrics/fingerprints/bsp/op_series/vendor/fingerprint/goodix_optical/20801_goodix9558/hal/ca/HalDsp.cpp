...
namespace goodix {
    ...
    HalDsp::HalDsp(CaEntry *caEntry) : mDspStatus(DSP_NOT_AVAILABLE) {
        mCaEntry = caEntry;
    ...
    gf_error_t HalDsp::initInternal() {
        ...
        do {
            ...
            ret = gf_proxy_dsp_init(fd, len, enable_log_dump);
    ...
    gf_error_t HalDsp::reinit() {
        ...
        do {
            ...
            ret = gf_proxy_dsp_reinit(fd, len, enable_log_dump);
            if (ret) {
