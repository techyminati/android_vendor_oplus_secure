...
LOCAL_MODULE := libgf_hal_dump_19811_G6_oplus
...
LOCAL_MODULE := libgf_hal_goodix_sec_19811_G6_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_ext_modules_19811_G6_oplus
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_product_test_19811_G6_oplus
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE := libgf_hal_19811_G6_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MULTILIB := both
...
CONFIG_MACROS += \
    ...
    -DGF_HAL_VERSION=\"38fcd06_db26a93_caeef16_2020.05.20_11:37:21\"
endif
ifeq ($(TARGET_MODE), release)
CONFIG_MACROS += \
    -DGF_LOG_LEVEL=3 \
    -DGF_HAL_VERSION=\"38fcd06_db26a93_caeef16_2020.05.20_11:40:00\"
endif

ifeq ($(TARGET_MODE), userdebug)
CONFIG_MACROS += \
    -DGF_HAL_VERSION=\"38fcd06_db26a93_caeef16_2020.05.20_11:38:41\"
endif
...
LOCAL_STATIC_LIBRARIES += \
    libgf_hal_dump_19811_G6_oplus \
    libgf_hal_goodix_sec_19811_G6_oplus \
    libgf_hal_ext_modules_19811_G6_oplus \
    libgf_hal_product_test_19811_G6_oplus
