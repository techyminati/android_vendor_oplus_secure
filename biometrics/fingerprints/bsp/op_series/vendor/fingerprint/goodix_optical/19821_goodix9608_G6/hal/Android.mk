...
LOCAL_MODULE := libgf_hal_dump_G6_oplus
...
LOCAL_MODULE := libgf_hal_goodix_sec_G6_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_ext_modules_G6_oplus
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_product_test_G6_oplus
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE := libgf_hal_G6_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MULTILIB := both
...
LOCAL_STATIC_LIBRARIES += \
    libgf_hal_dump_G6_oplus \
    libgf_hal_goodix_sec_G6_oplus \
    libgf_hal_ext_modules_G6_oplus \
    libgf_hal_product_test_G6_oplus
