...
LOCAL_MODULE := libgf_hal_goodix_sec
LOCAL_PROPRIETARY_MODULE := true
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE_TAGS := optional
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE := libgf_hal_ext_modules
LOCAL_SRC_FILES_32 := \
...
LOCAL_MODULE := libgf_hal_G5_oplus
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MULTILIB := both
...
# NO DSP FOR OP8
ifeq ($(OPLUS_DEVICE_SUPPORT_DSP_G5),ops)
CONFIG_MACROS += \
    -DSUPPORT_DSP_HAL \
...
LOCAL_SRC_FILES += \
    ...
    product_test/DelmarProductTest.cpp \
...
LOCAL_STATIC_LIBRARIES += \
    libgf_hal_dump \
    libgf_hal_goodix_sec \
    libgf_hal_ext_modules
