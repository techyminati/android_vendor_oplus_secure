...
#define GF_TRACE_INT(tag, value) do { UNUSED_VAR(tag, value); } while (0);
#define GF_TRACE_INT64(tag, value) do { UNUSED_VAR(tag, value); } while (0);
#define GF_TRACE_STR(tag, value) do { UNUSED_VAR(tag, value); } while (0);
#define GF_TRACE_BINARY(tag, value, value_len) do { UNUSED_VAR(tag, value, value_len); } while (0);
